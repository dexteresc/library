...
public class SearchModel {
    ...
    private static final String SEARCH_BOOK_STATEMENT =
    ...
    private static final String SEARCH_MOVIE_STATEMENT =
    ...
    private final ObservableList<Media> searchResultsList =
            FXCollections.observableList(new ArrayList<>());
    private final SimpleBooleanProperty noSearchResults = new SimpleBooleanProperty();
