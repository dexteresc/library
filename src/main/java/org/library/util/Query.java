 ...
 *
 * <p>Wraps a database query that returns does not return anything (except for a generated value, if
 * requested).
 */
public class Query {
                ...
                preparedStatement -> {
                    for (int i = 0; i < parameters.length; i++) {
                        ...
                        switch (parameterTypeName) {
                            ...
                            default:
                                throw new Exception(
                                        "Invalid parameter for prepared statement with value of type: "
                                                + parameterTypeName);
                        }
                    }
                });
